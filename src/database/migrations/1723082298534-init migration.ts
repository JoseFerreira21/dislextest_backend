...
export class initMigration1723082298534 implements MigrationInterface {
    name = 'initMigration1723082298534'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`INSERT INTO public.diccionario_discriminacion_palabras
                                ...
                                VALUES
                                    ...
                                    ('caballo', 4, 20)`); 
        //#4    
        await queryRunner.query(`INSERT INTO public.diccionario_encontrar_letras
        ...
        await queryRunner.query(`-- public.v_resultados source
                                CREATE OR REPLACE VIEW public.v_resultados
                                AS WITH ritem AS (
