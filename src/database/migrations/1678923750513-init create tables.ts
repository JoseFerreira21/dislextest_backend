...
export class initCreateTables1678923750513 implements MigrationInterface {
    name = 'initCreateTables1678923750513'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "usuarios" ("id" SERIAL NOT NULL, "email" character varying(255) NOT NULL, "password" character varying(128) NOT NULL, "role" character varying NOT NULL, "isSuperUser" character varying(1) NOT NULL, "isActive" character varying(1) NOT NULL, "lastLogin" date NOT NULL, "createAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updateAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_d7281c63c176e152e4c531594a8" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "alumnos" ("id" SERIAL NOT NULL, "entidadId" integer NOT NULL, "createAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updateAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "REL_9e59c7f6758053845c89a90bd1" UNIQUE ("entidadId"), CONSTRAINT "PK_c9eecfa0d05424c7d272034a706" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "profesores_alumnos_alumnos" ("profesoresId" integer NOT NULL, "alumnosId" integer NOT NULL, CONSTRAINT "PK_188ccadb3510787025e633488c0" PRIMARY KEY ("profesoresId", "alumnosId"))`);
        await queryRunner.query(`CREATE INDEX "IDX_e836f3819d00bf643017c57347" ON "profesores_alumnos_alumnos" ("profesoresId") `);
        await queryRunner.query(`CREATE INDEX "IDX_c444582a8d8143d54c04362e9e" ON "profesores_alumnos_alumnos" ("alumnosId") `);
        ...
        await queryRunner.query(`ALTER TABLE "profesores_alumnos_alumnos" ADD CONSTRAINT "FK_e836f3819d00bf643017c573475" FOREIGN KEY ("profesoresId") REFERENCES "profesores"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "profesores_alumnos_alumnos" ADD CONSTRAINT "FK_c444582a8d8143d54c04362e9e5" FOREIGN KEY ("alumnosId") REFERENCES "alumnos"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "profesores_alumnos_alumnos" DROP CONSTRAINT "FK_c444582a8d8143d54c04362e9e5"`);
        await queryRunner.query(`ALTER TABLE "profesores_alumnos_alumnos" DROP CONSTRAINT "FK_e836f3819d00bf643017c573475"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_c444582a8d8143d54c04362e9e"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_e836f3819d00bf643017c57347"`);
        await queryRunner.query(`DROP TABLE "profesores_alumnos_alumnos"`);
