...
export class Init1731291693536 implements MigrationInterface {
    name = 'Init1731291693536'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "instituciones" ("id" SERIAL NOT NULL, "tipo" character varying(255) NOT NULL, "descripcion" character varying(255) NOT NULL, "direccion" character varying(255) NOT NULL, CONSTRAINT "PK_4be89b4d1536e4588a73f2247d8" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "diccionario_contar_letras" ("id" SERIAL NOT NULL, "letra" character varying(1) NOT NULL, "cantidad" character varying(30) NOT NULL, "ejercicioOpcionesId" integer, CONSTRAINT "PK_720c9927940cf5ed04af35ba9be" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "diccionario_izquierda_derecha" ("id" SERIAL NOT NULL, "palabra" character varying(30) NOT NULL, "posicion" character varying(30) NOT NULL, "ejercicioOpcionesId" integer, CONSTRAINT "PK_0a25dd6d70e5d1af1e9da8c97e4" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "diccionario_letras_desordenadas" ("id" SERIAL NOT NULL, "palabra" character varying(30) NOT NULL, "ejercicioOpcionesId" integer, CONSTRAINT "PK_6c4d5e1cd998636d897771dfcf9" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "diccionario_encerrar_silabas_cf" ("id" SERIAL NOT NULL, "opciones" jsonb, "palabra" character varying(255) NOT NULL, "palabraIncompleta" character varying(255) NOT NULL, "ejercicioOpcionesId" integer, CONSTRAINT "PK_371d898e32bfe9964c22d49e922" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "diccionario_encerrar_silabas_cs" ("id" SERIAL NOT NULL, "opciones" jsonb, "palabra" character varying(255) NOT NULL, "palabraIncompleta" character varying(255) NOT NULL, "ejercicioOpcionesId" integer, CONSTRAINT "PK_53753bd005674eb799a6b79134a" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "diccionario_contar_letras" ADD CONSTRAINT "FK_bf444d183f974884011966fb090" FOREIGN KEY ("ejercicioOpcionesId") REFERENCES "ejercicios_opciones"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "diccionario_izquierda_derecha" ADD CONSTRAINT "FK_c420cd466b69a558aaee17c9c05" FOREIGN KEY ("ejercicioOpcionesId") REFERENCES "ejercicios_opciones"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "diccionario_letras_desordenadas" ADD CONSTRAINT "FK_ef0823dd54cef88faa74cfcd098" FOREIGN KEY ("ejercicioOpcionesId") REFERENCES "ejercicios_opciones"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "diccionario_encerrar_silabas_cf" ADD CONSTRAINT "FK_26ab098532374b5fcc21350c8ba" FOREIGN KEY ("ejercicioOpcionesId") REFERENCES "ejercicios_opciones"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "diccionario_encerrar_silabas_cs" ADD CONSTRAINT "FK_53f6e61edf9b1b96e13a1e780f9" FOREIGN KEY ("ejercicioOpcionesId") REFERENCES "ejercicios_opciones"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`CREATE OR REPLACE FUNCTION get_observacion_riesgo_dislexia(p_resultadotestId INTEGER)
                                    RETURNS TEXT AS $$
                                    DECLARE
                                        v_resultado TEXT;
        ...
        await queryRunner.query(`CREATE OR REPLACE FUNCTION get_indicador_riesgo_dislexia(p_resultadotestId INTEGER)
                                RETURNS TEXT AS $$
                                DECLARE
                                    v_indicador TEXT;
                                BEGIN
        ...
        //#6        
        await queryRunner.query(`INSERT INTO diccionario_letras_desordenadas
                                (palabra, "ejercicioOpcionesId")
                                VALUES
                                    ('ilaagnl', 35),
                                    ('angso', 36),
        ...
        //#7    
        await queryRunner.query(`INSERT INTO diccionario_encerrar_silabas_cs 
        ...
        //#8                            
        await queryRunner.query(`INSERT INTO diccionario_contar_letras
        ...
        //#10                            
        await queryRunner.query(`INSERT INTO diccionario_izquierda_derecha
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "diccionario_encerrar_silabas_cs" DROP CONSTRAINT "FK_53f6e61edf9b1b96e13a1e780f9"`);
        await queryRunner.query(`ALTER TABLE "diccionario_encerrar_silabas_cf" DROP CONSTRAINT "FK_26ab098532374b5fcc21350c8ba"`);
        await queryRunner.query(`ALTER TABLE "diccionario_letras_desordenadas" DROP CONSTRAINT "FK_ef0823dd54cef88faa74cfcd098"`);
        await queryRunner.query(`ALTER TABLE "diccionario_encontrar_letras" DROP CONSTRAINT "FK_230d2d0a24a8a7eab6b8c08d1cf"`);
        await queryRunner.query(`ALTER TABLE "diccionario_izquierda_derecha" DROP CONSTRAINT "FK_c420cd466b69a558aaee17c9c05"`);
        await queryRunner.query(`ALTER TABLE "diccionario_encerrar_palabras" DROP CONSTRAINT "FK_e71f0632266987b4ce61e0d4af1"`);
        await queryRunner.query(`ALTER TABLE "diccionario_contar_letras" DROP CONSTRAINT "FK_bf444d183f974884011966fb090"`);
        ...
        await queryRunner.query(`DROP TABLE "diccionario_encerrar_silabas_cs"`);
        await queryRunner.query(`DROP TABLE "diccionario_encerrar_silabas_cf"`);
        await queryRunner.query(`DROP TABLE "diccionario_letras_desordenadas"`);
        await queryRunner.query(`DROP TABLE "diccionario_encontrar_letras"`);
        await queryRunner.query(`DROP TABLE "diccionario_izquierda_derecha"`);
        await queryRunner.query(`DROP TABLE "diccionario_encerrar_palabras"`);
        await queryRunner.query(`DROP TABLE "diccionario_contar_letras"`);
